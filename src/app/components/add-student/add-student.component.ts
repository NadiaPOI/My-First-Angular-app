...
export class AddStudentComponent implements OnInit {
  ...
  newStudent = {
    ...
    // Création d'une variable pour récuperer la taille de la liste d'étudiants
    myListLength: number
  ...
  // Créer une fonction pour ajouter un étudiant ds la liste du service
  ...
  // Créer une fonction pour connaître la taille du tableau LIST du service
  getNextStudentId(){
